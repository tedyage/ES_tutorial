/*
padStart(),padEnd()
ES2017引入了字符串补全长度的功能，如果某个字符串不够指定长度，可在头部或尾部补全
*/

{
    ...
    //如果原字符串长度，大于等于字符串补全后最大长度，则补全不生效，仍返回源字符串
    console.log("str1.padStart(2,'0') is "+str1.padStart(2,'0'));
    console.log("str1.padEnd(2,'0') is "+str1.padEnd(2,'0'));
    //如果用来补全的字符串长度与源字符串长度相加，超过了指定的最大长度，则会从补全字符串尾部截取超出位数。
